  ...
  return (
    <>
      <section className="relative">
        ...
        <div className="relative z-10 px-5 pb-9 pt-36 md:px-8 md:pb-10 md:pt-28">
          <div className="hero-copy mx-auto w-full max-w-6xl">
            <p className="font-display text-[2rem] leading-[1.15] text-[#f3f0e8] drop-shadow-sm sm:text-5xl sm:leading-tight md:text-6xl">
              Gregg&apos;s Recipes
            </p>
